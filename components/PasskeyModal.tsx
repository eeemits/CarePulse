...
import React, { useState, type FunctionComponent, MouseEvent, useEffect } from "react";

export const PasskeyModal: FunctionComponent = () => {
  ...
  const validatePasskey = (event: MouseEvent<HTMLButtonElement>) => {
